...
test.describe('Tour Search', () => {
  ...
  for (const country of countries) {
    ...
    test(`should open search results page for ${country} country`, async ({ homePage, page }) => {
      await homePage.destinationFields().click()
      await homePage.destinationFields().fill(country)
    ...
    test(`should search for ${country} country and open second search page and verify offer information`, async ({ homePage, searchResultPage }) => {
      await homePage.destinationFields().click()
      await homePage.destinationFields().fill(country)
      await homePage.autoconmpleteItem(0).click()
      await homePage.datesField().click()
    ...
    test(`should open second search page and open any hotel info box for ${country} country`, async ({ homePage, searchResultPage }) => {
      await homePage.destinationFields().click()
